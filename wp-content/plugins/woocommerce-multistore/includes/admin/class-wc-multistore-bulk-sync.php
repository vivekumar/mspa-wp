...
class WC_Multistore_Bulk_Sync {
	...
	public function enqueue_assets() {
		if ( is_admin() ) {
			wp_register_style( 'wc-multistore-bulk-sync-css', WOO_MSTORE_ASSET_URL .'/assets/css/wc-multistore-bulk-sync.css', array(), '1.0.1' );
			wp_enqueue_style( 'wc-multistore-bulk-sync-css' );
			wp_enqueue_style( 'woocommerce_admin_styles' );

			wp_register_script( 'wc-multistore-bulk-sync-js', WOO_MSTORE_ASSET_URL . '/assets/js/wc-multistore-bulk-sync.js', array(), '1.0.1' );
