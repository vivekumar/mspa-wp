	...
	public function get_master_fields(){
		...
		foreach ( $this->sites as $site ) {
			...
			$fields[] = array(
				...
				'label'             => '',
				'description'       => '<b>' . $site->get_name() . '</b><span class="warning">' . __( '<b>Warning:</b> By deselecting this shop the product is unassigned, but not deleted from the shop, which should be done manually.', 'woonet' ) . '</span>',
				'type'              => 'checkbox',
				'disabled'          => '',
				'checked'           => $publish_to,
